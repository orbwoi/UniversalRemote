...
public class HookedIntegratedPlayerList extends IntegratedPlayerList {
	...
	// since they are not primitive types, accessing them by reference from parent is okay
	...
	public HookedIntegratedPlayerList(IntegratedPlayerList oldList) throws IllegalAccessException, NoSuchFieldException, SecurityException {
		...
		InjectionHandler.copyAllFieldsFrom(this, oldList, IntegratedPlayerList.class);

		// copy private references from parent class
		this.playerEntityList = InjectionHandler.readParameterizedFieldOfType(IntegratedPlayerList.class, this, List.class, (ParameterizedType) this.getClass().getDeclaredField("playerEntityList").getGenericType());
		this.mcServer = InjectionHandler.readFieldOfType(IntegratedPlayerList.class, this, MinecraftServer.class);
		this.uuidToPlayerMap = InjectionHandler.readParameterizedFieldOfType(IntegratedPlayerList.class, this, Map.class, (ParameterizedType) this.getClass().getDeclaredField("uuidToPlayerMap").getGenericType());
		this.gameType = InjectionHandler.readFieldOfType(IntegratedPlayerList.class, this, GameType.class);
