...
public class HookedDedicatedPlayerList extends DedicatedPlayerList {
	...
	public HookedDedicatedPlayerList(DedicatedPlayerList oldList) throws IllegalAccessException, NoSuchFieldException, SecurityException {
		...
		InjectionHandler.copyAllFieldsFrom(this, oldList, DedicatedPlayerList.class);

		// copy private references from parent class
		this.playerEntityList = InjectionHandler.readParameterizedFieldOfType(DedicatedPlayerList.class, this, List.class, (ParameterizedType) this.getClass().getDeclaredField("playerEntityList").getGenericType());
		this.mcServer = InjectionHandler.readFieldOfType(DedicatedPlayerList.class, this, MinecraftServer.class);
		this.uuidToPlayerMap = InjectionHandler.readParameterizedFieldOfType(DedicatedPlayerList.class, this, Map.class, (ParameterizedType) this.getClass().getDeclaredField("uuidToPlayerMap").getGenericType());
		this.gameType = InjectionHandler.readFieldOfType(DedicatedPlayerList.class, this, GameType.class);
	}
