...
public class OpenGuiWrapper extends FMLMessage.OpenGui {
	...
	public OpenGuiWrapper(int windowId, String modId, int modGuiId, int x, int y, int z) throws IllegalArgumentException, IllegalAccessException
	{
		f_windowId.setInt(this, windowId);
		f_modId.set(this, modId);
		f_modGuiId.setInt(this, modGuiId);
		f_x.setInt(this, x);
		f_y.setInt(this, y);
		f_z.setInt(this, z);
	}
