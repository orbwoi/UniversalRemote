...
public class OpenGuiFilterServer extends ChannelOutboundHandlerAdapter {
	...
	public static class RemoteGuiExtraData
	{
		...
		public RemoteGuiExtraData(int iBlockId, NBTTagCompound iTag, BlockPos pos, String iModId, int idimensionId)
		{
    ...
    public void write(ChannelHandlerContext ctx, Object msg, ChannelPromise promise) throws Exception
    {
        ...
        try {
            ...
            if (acceptOutboundMessage(msg)) {
            	 ...
            	 Object playerObject = 
                (EntityPlayerMP) ctx.channel().attr(FMLOutboundHandler.FML_MESSAGETARGETARGS).get();
	            			 ...
	            			 if (data.count < 2)
	            			 {
		            			 ...
		            			 if (this.dataMatches(imsg, data))
		            			 {
					            	 ...
					            	 UniversalRemotePacketHandler.INSTANCE.sendTo(
					            			 new OpenRemoteGuiMessage(imsg, data.blockId, data.tag, data.dimensionId), entityPlayerMP);				            	 
    ...
    public void setPlayerData(World world, EntityPlayer player, BlockPos blockPosition)
	{
		...
		m_playerData.put(player,
				new OpenGuiFilterServer.RemoteGuiExtraData(id, tiletag, blockPosition, modId, world.provider.getDimension()));
